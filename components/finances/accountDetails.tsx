...
export default async function AccountDetails({
  ...
  return (
    <div
      className={clsx(
        "py-4 grid grid-rows-[2fr_1fr] md:grid-cols-[2fr_1fr] gap-4",
        className,
      )}
    >
      ...
      <div className={"flex flex-col gap-2"}>
        <div
          className={
            "flex flex-col gap-2 items-center rounded-md bg-ts-blue-600 border-ts-blue-500 border p-2"
          }
        >
          <span className={"text-2xl font-bold my-4"}>
            {gbpFormat.format(details.endingBalance)}
          </span>
        ...
        >
          <span className={"text-2xl font-bold my-4"}>
            {gbpFormat.format(details.startingBalance)}
          </span>
