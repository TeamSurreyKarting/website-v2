...
export const columns: ColumnDef<MembershipNested>[] = [
  {
    ...
    cell: ({ row }) => {
      return (
        <Link href={`/members/memberships/${row.original.MembershipTypes?.id}`}>
          {row.original.MembershipTypes?.name}
        </Link>
      );
    },
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <Link href={`/racers/${row.original.Racers?.id}`}>
          {row.original.Racers?.fullName}
        </Link>
      );
    },
  },
