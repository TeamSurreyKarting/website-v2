...
export function AssignMembershipForm(
	{ memberships, racers, defaultRacer }:
	{ memberships: Database['public']['Tables']['MembershipTypes']['Row'][], racers: Database['public']['Tables']['Racers']['Row'][], defaultRacer: string | null }
) {
	...
	return (
		<Form {...form}>
			<form onSubmit={form.handleSubmit(onSubmit)} className={"space-y-6 mt-4"}>
				...
				<LoadingButton className={"bg-ts-blue-700 hover:bg-white hover:text-black float-right"} variant={"outline"} type={"submit"} loading={form.formState.isSubmitting}>Assign Membership</LoadingButton>
			</form>
		</Form>
	);
}
